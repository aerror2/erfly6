...
const prog_char *const n_Templates[9] = {
    string_1,
    string_2,
    string_3,
    string_4,
...
#ifndef NO_TEMPLATES
const prog_int8_t heli_ar1[]  = {-100, 20, 30, 70, 90};
const prog_int8_t heli_ar2[]  = {80, 70, 60, 70, 100};
const prog_int8_t heli_ar3[]  = {100, 90, 80, 90, 100};
const prog_int8_t heli_ar4[]  = {-30, -15, 0, 50, 100};
const prog_int8_t heli_ar5[]  = {-100, -50, 0, 50, 100};
#endif
